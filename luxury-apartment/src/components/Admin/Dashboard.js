    ...
    return (
        <>
            <header style={{ backgroundColor: '#d2dae1', display: 'flex', justifyContent: 'space-around', alignItems: 'center' }} className="navbar-dark sticky-top  flex-md-nowrap p-0 shadow">
                <div>
                    <img src='../logo.png' style={{ width: '80px' }} alt='Company logo'></img>
                    <Link style={{fontSize:'16px'}} className="navbar-brand ol-md-3 col-lg-2 me-0 px-3" to="#">Villa Agency</Link>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: 'large' , cursor:'pointer'}}>
                    ...
                    <div>
                        <img src="../images/ducnguyen.jpg" alt="avatar" style={{ width: '40px', height: '40px', borderRadius: '50%' }}></img>
                        <span style={{ margin: '0 10px', fontWeight:'bold' }}>Đức Nguyễn</span>
                    </div>
                </div>
            </header>
